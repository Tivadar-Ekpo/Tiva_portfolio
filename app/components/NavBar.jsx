...
const NavBar = () => {
  ...
  return (
    <>
      ...
      ${isScroll ? "bg-white opacity-90 backdrop-blur-lg shadow-sm" : ""}`}>
        <a href="#top">
          <Image
            src={assets.logo}
            alt=""
        ...
        <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3
          ${isScroll ? " " : "bg-white opacity-50 shadow-sm"} `}>
          <li>
            <a href="#top"> Home </a>
          </li>
          <li>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="block md:hidden ml-3">
            <Image src={assets.menu_black} alt="" className="w-6 cursor-pointer" onClick={openMenu}/>
          </button>
        </div>
